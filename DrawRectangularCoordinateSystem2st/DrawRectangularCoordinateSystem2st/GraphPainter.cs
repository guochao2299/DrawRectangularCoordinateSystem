...
namespace DrawRectangularCoordinateSystem2st
{
    public class GraphPainter
    {
        ...
        private int m_yAxeCount = 1;
        public GraphPainter(int yAxeCount)
        {
            if (yAxeCount <= 0)
            {
